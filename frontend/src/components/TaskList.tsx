...
const TaskList: React.FC<TaskListProps> = ({ tasks, onComplete }) => {
  if (!tasks || tasks.length === 0) {
    return (
      <div data-testid="empty-task-list" className="bg-white dark:bg-zinc-900/50 rounded-xl shadow-md p-12 text-center border-l-4 border-[#2563EB] dark:border-blue-400 dark:border dark:border-l-4">
